                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF2DD4BF), Color(0xFF3B82F6)], // Teal 400 to Blue 500
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        colors: [Color(0xFF3B82F6), Color(0xFF10B981)], // Blue 500 to Emerald 500
                      ),
                      boxShadow: [
                        BoxShadow(
                  ...
                  IconButton(
                    icon: Icon(Icons.logout_rounded, color: Colors.white.withValues(alpha: 0.45), size: 18),
                    onPressed: () {
                      context.go('/auth');
                    },
                    tooltip: 'Logout',
    ...
    return Container(
      ...
      child: Material(
        ...
        child: ListTile(
          ...
          leading: Icon(icon, color: isSelected ? activeColor : Colors.white.withValues(alpha: 0.55), size: 20),
          title: Text(
            title,
            style: TextStyle(
